        ...
        <div class="col-lg-8" style="padding-bottom: 10px">
            <form method="POST" action="/dashboard/products/{{ $product->slug }}" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="nama_produk" name="nama_produk" required value="{{ old('nama_produk',$product->nama_produk) }}">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select" name="kategori_id" id="kategori_id">
                        @foreach ($categories as $category)
                            @if (old('kategori_id',$product->kategori_id) == $category->id)
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select" name="admin_id" id="admin_id">
                        @foreach ($admins as $admin)
                            @if (old('admin_id',$product->admin_id) == $admin->id)
                ...
                <div class="mb-3">
                    ...
                    @if ($product->image)
                        <img src="{{ asset($product->image) }}" class="img-preview img-fluid mb-3 col-sm-5 d-block">
                    @else
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control" id="jumlah" name="jumlah" required value="{{ old('jumlah',$product->jumlah) }}">
                </div>
                <div class="mb-3">
                    <label for="harga" class="form-label">Price</label>
                    <input type="number" class="form-control" id="harga" name="harga" required value="{{ old('harga',$product->harga) }}">
                </div>
                <div class="mb-3">
                    <label for="deskripsi" class="form-label">Description (Deskripsi)</label>
                    <input class="@error('deskripsi') is-invalid @enderror" id="deskripsi" type="hidden" name="deskripsi" required value="{{ old('deskripsi',$product->deskripsi) }}">
