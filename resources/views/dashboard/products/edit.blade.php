        ...
        <div class="col-lg-8" style="padding-bottom: 10px">
            <form method="POST" action="/dashboard/products/{{ $product->slug }}">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="image" name="image" required value="{{ old('image',$product->image) }}">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input id="deskripsi" type="hidden" name="deskripsi" required value="{{ old('deskripsi',$product->deskripsi) }}">
