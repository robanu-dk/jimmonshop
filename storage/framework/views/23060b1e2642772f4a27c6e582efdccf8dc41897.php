        ...
        <div class="col-lg-8" style="padding-bottom: 10px">
            <form method="POST" action="/dashboard/products">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="nama_produk" name="nama_produk" required value="<?php echo e(old('nama_produk')); ?>">
                </div>
                <div class="mb-3">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control" id="jumlah" name="jumlah" required value="<?php echo e(old('jumlah')); ?>">
                </div>
                <div class="mb-3">
                    <label for="harga" class="form-label">Price</label>
                    <input type="number" class="form-control" id="harga" name="harga" required value="<?php echo e(old('harga')); ?>">
                </div>
                <div class="mb-3">
                    <label for="deskripsi" class="form-label">Description</label>
                    <input id="deskripsi" type="hidden" name="deskripsi" required value="<?php echo e(old('deskripsi')); ?>">
...
<?php echo $__env->make('dashboard.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ROBANU DAKHAYIN\Documents\ApplicationWeb\jimmonshop\resources\views/dashboard/products/create.blade.php ENDPATH**/ ?>