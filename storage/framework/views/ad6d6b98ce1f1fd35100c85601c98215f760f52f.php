        ...
        <div class="col-lg-8" style="padding-bottom: 10px">
            <form method="POST" action="/dashboard/categories">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="nama_kategori" name="nama_kategori" required value="<?php echo e(old('nama_kategori')); ?>">
                </div>
                <div class="mb-3">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-3">
                    ...
                    <input id="keterangan" type="hidden" name="keterangan" required value="<?php echo e(old('keterangan')); ?>">
...
<?php echo $__env->make('dashboard.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ROBANU DAKHAYIN\Documents\ApplicationWeb\jimmonshop\resources\views/dashboard/categories/create.blade.php ENDPATH**/ ?>